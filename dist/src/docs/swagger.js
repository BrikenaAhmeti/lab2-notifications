...
const activity_event_projector_1 = require("../modules/dashboard/domain/activity-event-projector");
const chat_entity_1 = require("../modules/chat/domain/chat.entity");
const notification_entity_1 = require("../modules/notifications/domain/notification.entity");
...
exports.swaggerSpec = (0, swagger_jsdoc_1.default)({
    definition: {
        ...
        info: {
            ...
            version: '1.0.0',
            description: 'REST APIs for notifications, MS-52 chat, and MS-54 dashboard activity. Socket.IO clients authenticate with the same JWT and receive notification:new, notification:read, notification:all-read, activity:new, chat:message, and chat:read events.',
        },
        servers: [
            {
        ...
        tags: [
            ...
            },
            {
                ...
                description: 'Service-to-service notification ingress secured with x-internal-api-key.',
            },
            {
                name: 'Notifications',
            ...
            },
            {
                ...
                description: 'Service-to-service activity feed ingress secured with x-internal-api-key.',
            },
            {
                name: 'Dashboard',
            ...
            {
                name: 'Chat',
                description: 'Authenticated chat rooms, message history, read receipts, and attachments.',
            },
        ],
        components: {
            securitySchemes: {
                bearerAuth: {
                    ...
                    scheme: 'bearer',
                    bearerFormat: 'JWT',
                    description: 'Access token issued by the Auth Service. The user id may be in sub, userId, or id.',
                },
                internalApiKey: {
                    type: 'apiKey',
                    in: 'header',
            ...
            schemas: {
                ...
                Notification: {
                    ...
                    properties: {
                        ...
                        channels: {
                            type: 'array',
                            items: { type: 'string', enum: [...notification_entity_1.notificationChannels] },
                ...
                LegacySendNotificationRequest: {
                    ...
                    properties: {
                        ...
                        channels: {
                            ...
                            default: ['in_app'],
                            example: ['in_app', 'email'],
                            description: 'Must include in_app. Add email when SMTP delivery should also be attempted.',
                        },
                        recipientEmail: {
                            type: 'string',
                            format: 'email',
                ...
                TypedNotificationRecipient: {
                    ...
                    properties: {
                        role: {
                            type: 'string',
                            enum: [...notification_events_1.notificationRecipientRoles],
                            example: 'patient',
                        },
                        userId: {
                            type: 'string',
                ...
                TypedSendNotificationRequest: {
                    ...
                    properties: {
                        type: {
                            type: 'string',
                            enum: [...notification_events_1.notificationEventTypes],
                        ...
                        recipients: {
                            ...
                            description: 'Roles must match the selected notification type. Required userId/email depends on the type channel definitions.',
                        },
                        data: {
                            type: 'object',
                            additionalProperties: true,
                            default: {},
                            description: 'Event data used by service templates, such as appointmentId, scheduledAt, serviceName, resetUrl, or inventoryItemId.',
                        },
                        title: {
                            type: 'string',
                            minLength: 1,
                ...
                TypedNotificationResult: {
                    ...
                    properties: {
                        ...
                        emailOnlyCount: {
                            type: 'integer',
                            minimum: 0,
                            description: 'Number of recipients that were email-only because the event has no in-app channel.',
                            example: 0,
                        },
                    },
                },
                ...
                DomainActivityEventRequest: {
                    ...
                    properties: {
                        type: {
                            type: 'string',
                            enum: [...activity_event_projector_1.activityDomainEventTypes],
                ...
                ChatMessagePreview: {
                    ...
                    properties: {
                        ...
                        type: { type: 'string', enum: [...chat_entity_1.chatMessageTypes], example: 'text' },
                        fileUrl: {
                            type: 'string',
                            nullable: true,
                            example: null,
                ...
                CreateDirectChatRoomRequest: {
                    ...
                    properties: {
                        ...
                        participantRole: {
                            type: 'string',
                            enum: [...chat_entity_1.chatParticipantRoles],
                            example: 'doctor',
                        },
                    },
                },
                SendChatMessageRequest: {
                    ...
                    properties: {
                        ...
                        type: {
                            type: 'string',
                            enum: [...chat_entity_1.chatMessageTypes],
                            default: 'text',
                            example: 'text',
                        },
                        fileUrl: {
        ...
        paths: {
            ...
            '/internal/notifications/send': {
                post: {
                    ...
                    description: 'Accepts the legacy direct payload or the typed event payload used by MedSphere services. Typed events render titles/messages and validate required recipient roles.',
                    ...
                    responses: {
                        201: {
                            description: 'Notification created or typed notification event processed.',
                            content: {
                                'application/json': {
                                    schema: {
            ...
            '/api/notifications/read-all': {
                put: {
                    ...
                    responses: {
                        200: {
                            description: 'Notifications marked read and notification:all-read emitted.',
                            content: {
                                'application/json': {
                                    schema: {
            ...
            '/api/notifications/{id}/read': {
                put: {
                    ...
                    responses: {
                        200: {
                            description: 'Notification marked read and notification:read emitted.',
                            content: {
                                'application/json': {
                                    schema: {
            ...
            '/api/chat/rooms/{roomId}/messages': {
                ...
                post: {
                    ...
                    responses: {
                        201: {
                            description: 'Message persisted and emitted with chat:message.',
                            content: {
                                'application/json': {
                                    schema: {
            ...
            '/api/chat/rooms/{roomId}/read': {
                patch: {
                    ...
                    responses: {
                        200: {
                            description: 'Messages marked read and chat:read emitted when readCount is greater than zero.',
                            content: {
                                'application/json': {
                                    schema: {
