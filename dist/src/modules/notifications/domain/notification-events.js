...
exports.notificationEventDefinitions = exports.notificationRecipientRoles = exports.notificationEventTypes = void 0;
exports.renderNotificationEvent = renderNotificationEvent;
exports.resolveNotificationEventLink = resolveNotificationEventLink;
...
exports.notificationRecipientRoles = [
    'patient',
    'staff',
    'doctor',
    'admin',
...
exports.notificationEventDefinitions = {
    'appointment.booked': {
...
function renderNotificationEvent(type, data = {}) {
    return exports.notificationEventDefinitions[type].render(data);
}
function resolveNotificationEventLink(type, data, recipientRole, explicitLink) {
